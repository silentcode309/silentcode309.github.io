...
$(function(){
   	//make connection
	var socket = io.connect('https://silentcode309.github.io/')
	...
	var temp_usernames = ["Isaac", "George", "Frank", "Joe", "John", "Luis", "Dave", "Jack", "Hunter", "Parker", "Sofi", "Elliot", "Jason", "Steve", "Bob", "Kevin", "London", "Forest", "Taylor", "Owen", "Josiah", "Simon", "Trevor", "BRETT", "Asher", "James", "Skylar", "Peter", "Scott", "Hank", "Tony", "Nick", "Flynn", "Rider", "Carol", "Mike", "Katie", "Donald", "Bryan"]
